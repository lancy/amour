...
def appendListToFileWithListAndFileName(list, fileName):
    file = open(fileName, "a")
    for item in list:
        file.write("%s\n" % item.encode("UTF-8", errors="strict"))


def appendListToDefaultMisFileWithList(list):
    misFileName = "misFileName.txt"
    appendListToFileWithListAndFileName(list, misFileName)


def appendListToDefaultHitFileWithList(list):
    hitFileName = "hitFileName.txt"
    appendListToFileWithListAndFileName(list, hitFileName)


def defaultTokensProbabilityTable():
    hitFileName = "hitFileName.txt"
    misFileName = "misFileName.txt"
...
#
#tokensProbabilityTable = defaultTokensProbabilityTable()
#
#
#print "System Test"
